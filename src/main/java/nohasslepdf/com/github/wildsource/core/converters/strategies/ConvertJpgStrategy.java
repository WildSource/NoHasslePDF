...
public class ConvertJpgStrategy implements ConverterStrategy {
	...
	/**
	 * @param name of the jpg file without the extensions ex: "nameOfImage"
	 */
	@Override
	public void convert(String filePath) {
		...
		try {
			...
			PdfWriter.getInstance(document, new FileOutputStream(filePath.replace(".jpg", ".pdf")));
			...
			com.lowagie.text.Image jpg = com.lowagie.text.Image.getInstance(resizedImage, null);
